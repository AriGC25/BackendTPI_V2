    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        // --- ENDPOINTS TRACKING ---
                        // CLIENTE puede ver su propio tracking, OPERADOR y TRANSPORTISTA pueden ver todos
                        .requestMatchers(HttpMethod.GET, "/tracking/**").hasAnyRole("CLIENTE", "OPERADOR", "TRANSPORTISTA")
                        // OPERADOR y TRANSPORTISTA pueden crear o actualizar tracking
                        .requestMatchers(HttpMethod.POST, "/tracking/**").hasAnyRole("OPERADOR", "TRANSPORTISTA")
                        .requestMatchers(HttpMethod.PUT, "/tracking/**").hasAnyRole("OPERADOR", "TRANSPORTISTA")
